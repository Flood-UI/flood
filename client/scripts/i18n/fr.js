export default {
  ...
  'alert.torrent.add.failed': `Echec de l'ajout de {countElement} {count, plural,
      =1 {torrent}
      other {torrents}
    }.`,
  ...
  'alert.torrent.move.failed': `Echec du déplacement de {countElement} {count, plural,
      =1 {torrent}
      other {torrents}
    }.`,
  ...
  'alert.torrent.remove.failed': `Echec de la suppression de {countElement} {count, plural,
      =1 {torrent}
      other {torrents}
    }.`,
  'alert.settings.saved': 'Modifications des paramètres réussi.',

  'priority.dont.download': 'Arrêter',
  'priority.high': 'Haut',
  'priority.low': 'Bas',
  ...
  'settings.connectivity.peer.exchange.label': 'Activer l\'échange entre Pairs',
  ...
  'settings.connectivity.peers.seeding.max.label': 'Pairs en Partage Maximum',
  'settings.connectivity.peers.seeding.min.label': 'Pairs en Partage Minimum',
  ...
  'settings.resources.disk.heading': 'Stockage',
  'settings.resources.max.open.files': 'Fichiers Ouverts Maximum',
  'settings.resources.memory.heading': 'Mémoire Vive',
  'settings.resources.memory.max.label': 'Utilisation Maximale de la Mémoire Vive',
  ...
  'torrents.add.start.label': 'Démarrer le Torrent',
  ...
  'torrents.details.general.scheduler.obeyed': 'Réalisé',
  'torrents.details.general.scheduler': 'Planification',
  'torrents.details.general.seeds': 'Partage',
  ...
  'torrents.move.data.label': 'Déplacer',
  ...
  'torrents.remove.error.no.torrents.selected': 'Aucun Torrent sélectionné.',
  'torrents.remove': 'Supprimer un Torrent'
};
