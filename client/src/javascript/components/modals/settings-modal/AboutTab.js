    ...
    return (
      <div>
        <p>
            ...
            <br/>
            Flood is another web interface for <a href="https://github.com/rakshasa/rtorrent" rel="noopener noreferrer" target="_blank">rtorrent</a>. It implements a Node.js server for communicating with the rTorrent API, storing historical data, and serving the web UI.
            <br/>
            <br/>
            <strong>Links</strong>
            <br/>
            Source code at <a href="https://github.com/jfurrow/flood" rel="noopener noreferrer" target="_blank">GitHub</a>.
            <br/>
            Join our <a href="https://discord.gg/Z7yR5Uf" rel="noopener noreferrer" target="_blank">Discord server</a>.
        </p>
      </div>
    );
  }
