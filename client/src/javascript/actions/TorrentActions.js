...
const TorrentActions = {
  addTorrentsByUrls: options => axios
  ...
  addTorrentsByFiles: (formData, destination) => axios
  ...
  deleteTorrents: (hash, deleteData) => axios
  ...
  fetchTorrentDetails: hash => axios
  ...
  moveTorrents: (hashes, options) => {
    const {
      destination, isBasePath, filenames, sources, moveFiles,
    } = options;
  ...
  setPriority: (hash, priority) => axios
  ...
  setFilePriority: (hash, fileIndices, priority) => axios
  ...
  setTaxonomy: (hashes, tags, options = {}) => axios
